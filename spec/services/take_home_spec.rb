...
describe TakeHome do
  ...
  let(:facebook_response_body) { File.open('./spec/fixtures/facebook_response_body.json') }
  ...
  it "returns fb posts when the API call is made" do
    stub_request(:get, "#{base_uri}/facebook").to_return( body: facebook_response_body, status: 200)
